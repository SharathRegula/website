...
export default function ProjectCard(props) {
  ...
  <br/>{props.descline3}
            ...
            <div> {props.tagline && <p className="mb-3 font-normal text-gray-700 dark:text-white">{props.tagline}</p>}</div>
            <div> {props.desc && <p className="mb-3 font-normal text-gray-700 dark:text-white">{props.desc}</p>}</div>
            <div> {props.link && <p className="mb-3 font-normal text-gray-700 dark:text-white">{props.link}</p>}</div>

          </div>
        </div>
        <div className="m-2">
          <img className="object-cover w-full rounded-t-lg h-full md:h-40 md:w-60 md:rounded-none md:rounded-r-lg" src={props.img} alt="" />
        </div>
      </div>
    </div>
    ...
    <div className="max-w-sm bg-gradient-to-r from-green-400 to-blue-500 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 lg:hidden">
      ...
      <div className="p-5">
        <div>
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-slate-900">{props.title}</h5>
        </div>
        {/*   <p className="mb-3 font-normal text-slate-700"><b>{props.descline1}
       <br/>{props.descline2}
       <br/>{props.descline3}</b></p>*/}
        {props.tagline && <div><p className="mb-3 font-normal text-gray-700 dark:text-white">{props.tagline}</p></div>}
        {props.desc && <div><p className="mb-3 font-normal text-gray-700 dark:text-white">{props.desc}</p></div>}
        {props.link && <div><p className="mb-3 font-normal text-gray-700 dark:text-white">{props.link}</p></div>}
